/*
  ...
  - You are about to alter the column `efectivo` on the `Caja` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Decimal`.
